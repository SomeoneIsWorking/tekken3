...
| Static-path removal | Delete the generator, generated corpus, seed manifest, static dispatcher/bindings, and generated-symbol tests after the representative-gameplay gate passes | target: no generated execution path in the repository or product | native/Lightrec conformance gate | `docs/project-state.md` |
